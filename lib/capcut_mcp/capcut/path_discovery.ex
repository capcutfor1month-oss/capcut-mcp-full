defmodule CapcutMcp.CapCut.PathDiscovery do
  ...
  Resolution strategy, first match wins:
    ...
    2. `%LOCALAPPDATA%\\CapCut\\User Data\\Projects\\com.lveditor.draft`
       if that directory actually exists on disk.

  If neither hits, `discover/0` returns a descriptive error that callers can
  ...
  def discover do
    from_app_env() || from_localappdata() || {:error, not_found_message()}
  end
